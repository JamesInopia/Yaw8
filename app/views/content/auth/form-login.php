<form class="auth-form" id="loginForm" data-auth-form="login" novalidate>
    ...
    <div class="form-group">
        ...
        <div class="form-input-wrap form-input-icon-left">
            ...
            <input type="email" class="form-input" placeholder="yourstudentid@iacademy.edu.ph" id="loginEmail" autocomplete="email" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="form-input-wrap form-input-icon-left">
            ...
            <input type="password" class="form-input" placeholder="Enter your password" id="loginPassword" autocomplete="current-password" />
    ...
    <div class="auth-divider"><span>or continue as a</span></div>

    <div class="auth-social-row">
        <button type="button" class="auth-social-btn auth-guest-btn" data-guest-btn>
    ...
    <p class="auth-switch-text">
        ...
        <button type="button" data-auth-switch="signup">Sign Up</button>
    </p>
</form>