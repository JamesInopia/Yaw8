...
function initMyGamesPage(initialGames) {
    ...
    // Opened only from the Manage modal's "Edit Game" button. Kept
    // completely separate from the Submit/Add modal above — its own
    // fields, its own chip/thumbnail state, and its own AJAX endpoint.
    // ═══════════════════════════════════════════
